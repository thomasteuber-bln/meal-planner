...
const en = {
  ...
  ingredientsHint:
    "Optional, comma-separated or scan a photo of your fridge or pantry.",
  photoScanButton: "Scan photo",
  photoScanning: "Scanning photo…",
  photoScanFound: "Added {count} ingredient(s) from your photo.",
  photoScanNone: "No food ingredients detected in the photo.",
  photoScanError: "Could not analyze the photo. Try again or enter ingredients manually.",
...
const de: typeof en = {
  ...
  ingredientsHint:
    "Optional, durch Komma getrennt oder Foto vom Kühlschrank/Vorrat scannen.",
  photoScanButton: "Foto scannen",
  photoScanning: "Foto wird analysiert…",
  photoScanFound: "{count} Zutat(en) aus deinem Foto hinzugefügt.",
  photoScanNone: "Keine Lebensmittel im Foto erkannt.",
  photoScanError:
    "Foto konnte nicht analysiert werden. Erneut versuchen oder Zutaten manuell eingeben.",
